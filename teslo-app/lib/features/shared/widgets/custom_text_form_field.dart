    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          errorBorder: border.copyWith( borderSide: BorderSide( color: Colors.red.shade50 )),
          focusedErrorBorder: border.copyWith( borderSide: BorderSide( color: Colors.red.shade50 )),
          isDense: true,
